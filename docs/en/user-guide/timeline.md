...
## Overview
The main timeline is used to visually grasp the overall flow of the project. It displays the playhead indicating the current playback position and the waveform of recorded audio clips.
