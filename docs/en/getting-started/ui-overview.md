...
> Explains the roles and layout of the various panels on OpenDAW's main screen.

## Overview
OpenDAW's main screen consists of several panels designed to maximize workflow efficiency. It features a glassmorphic design that enables intuitive operation.
...
> - In the current version, the ability to resize panels by dragging their borders has limited support.
